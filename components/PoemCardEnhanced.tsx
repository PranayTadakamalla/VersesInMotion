...
interface PoemCardEnhancedProps {
  id: number;
  title: string;
  content: string;
  author: string;
...
export default function PoemCardEnhanced({
  id,
  title,
  content,
  author,
        ...
        <div className="relative p-6 md:p-8 h-full flex flex-col justify-between z-10">
          ...
          {showActions && (
            ...
            >
              <motion.button
                ...
                className={`p-2 rounded-full transition-all ${
                  isFavorite(id)
                    ...
                    : "bg-black/40 text-stone-400 hover:bg-amber-600/30"
                }`}
              ...
              <motion.button
                onClick={handleCopy}
                className="p-2 rounded-full bg-black/40 text-stone-400 hover:bg-amber-600/30 transition-all"
                whileHover={{ scale: 1.1 }}
                whileTap={{ scale: 0.95 }}
                title="Copy"
              >
